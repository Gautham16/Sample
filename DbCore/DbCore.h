...
// Author: Gautham Kanekal, Syracuse University                    //
/////////////////////////////////////////////////////////////////////
/*
* Package Operations:
* -------------------
...
* --------------------
* ver 1.2 : 7 Feb 2018
* - added the Payload class that contains the path to a file in the repository
* ver 1.1 : 19 Jan 2018
...
namespace NoSqlDb
{
	...
	*/
	...
	//------< Demonstartes Clearing all the values corresponding to particular key >-------------------------
	...
	//---------< Demonstrates deletion of key in the database>------------------------
	...
	//---------< Demonstrates editing the key in the database >------------------------
	template<typename T>
	...
	//---------< Demonstartes addition of a key in the database  >------------------------
	template<typename T>
